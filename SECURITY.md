...
2. Open a [GitHub Security Advisory](https://github.com/JXXR1/sentinel/security/advisories/new) (private disclosure).
3. Include:
...
In scope:
- Detection bypasses in any of the 7 scripts
